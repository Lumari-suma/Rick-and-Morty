...
}) 
 {
  ...
  return (
    <div className={style.cardContainer}>
      ...
      <h2 className={style.cardInfo}>Nombre: {name}</h2>
      <h2 className={style.cardInfo}>Especie: {species}</h2>
      <h2 className={style.cardInfo}>Genero:{gender}</h2>
      <h2 className={style.cardInfo}>Stado: {status}</h2>
      <h2 className={style.cardInfo}>Origen: {origin}</h2>
      <Link to={`/detail/${id}`}>
